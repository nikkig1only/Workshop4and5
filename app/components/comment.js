  ...
  handleLikeClick(clickEvent) {
    ...
    if (clickEvent.button === 0) {
      ...
      if (this.didUserLike()) {
        ...
        unlikeComment(this.props.source,this.props.id, 4, callbackFunction);
      } else {
        // User clicked 'like' button.
        likeComment(this.props.source,this.props.id, 4, callbackFunction);
      }
    }
  }
    ...
    return (
      <div>
        ...
        <div className="media-body">
          ...
          <br /><a href="#" onClick={(e) => this.handleLikeClick(e)}> {likeButtonText} </a> · <a href="#"> Reply </a> · <a href="#"> {this.state.likeCounter.length} </a> · {unixTimeToString(this.props.postDate)}
        </div>
      </div>
    )
  }
